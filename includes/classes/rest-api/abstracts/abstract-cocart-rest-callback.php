<?php
/**
 * Abstract: Handles callbacks.
 *
 * @author  Sébastien Dumont
 * @package CoCart\API\Abstracts
...
abstract class CoCart_REST_Callback {
	 ...
	 *
	 * @since 3.1.0 Introduced.
	 * @since 4.0.0 Added the rest controller as a parameter.
	 *
	 * @param WP_REST_Request $request    The request object.
	 * @param object          $controller The rest controller.
	 */
