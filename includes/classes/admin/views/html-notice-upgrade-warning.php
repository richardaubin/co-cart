	...
	<div class="cocart-notice-inner">
		...
		<div class="cocart-notice-content">
			...
			printf(
				...
				esc_html__( 'Version %2$s of %1$s is in development with many improvements and options including improved security. A newly added settings page with multiple options to quickly configure %1$s as you need and many more action hooks and filters for developers.', 'cocart-core' ),
				'CoCart',
		...
		<div class="cocart-action">
			<?php printf( '<a href="%1$s" class="button button-primary cocart-button" target="_blank" rel="noopener noreferrer">%2$s</a>', esc_url( 'https://github.com/co-cart/co-cart/blob/dev/NEXT_CHANGELOG.md' ), esc_html__( "What's Coming Next?", 'cocart-core' ) ); ?>
