...
<ul class="cocart-next-steps">
	...
	<li class="cocart-additional-steps">
		...
		<div class="cocart-next-step-action">
			<p class="cocart-actions step">
				<a class="button cocart-button-alt" href="<?php echo esc_url( CoCart_Helpers::build_shortlink( add_query_arg( $campaign_args, esc_url( COCART_STORE_URL . 'community/' ) ) ) ); ?>" target="_blank" rel="noopener noreferrer">
				...
				if ( apply_filters( 'cocart_show_upgrade_action_link', true ) ) {
					?>
				<a class="button cocart-button-alt" href="<?php echo esc_url( CoCart_Helpers::build_shortlink( add_query_arg( $campaign_args, esc_url( COCART_STORE_URL . 'pricing/' ) ) ) ); ?>" target="_blank" rel="noopener noreferrer">
						<?php esc_html_e( 'Unlock more features', 'cart-rest-api-for-woocommerce' ); ?>
				</a><?php } ?>
				<a class="button cocart-button-alt" href="<?php echo esc_url( 'https://marketplace.visualstudio.com/items?itemName=sebastien-dumont.cocart-vscode' ); ?>" target="_blank" rel="noopener noreferrer">
