 ...
 *
 * Tests for CoCart calculate cart API endpoints including cart totals
 * calculation, tax calculations, and shipping calculations.
 *
 * @package CoCart\Tests\Unit
 */

/**
 * Test CoCart Calculate Controller Class
 *
 * Tests the calculate cart API endpoints which handle cart calculations
 * including totals, taxes, fees, and shipping calculations.
 *
 * @package CoCart\Tests\Unit
 */
class Test_CoCart_Calculate_Controller extends CoCart_API_V2_Test_Case {
	 ...
	 *
	 * Verifies that cart totals can be successfully calculated
	 * and that the response contains the correct calculation data.
	 *
	 * @return void
	 */
	...
	/**
	 * Test calculating cart with tax.
	 *
	 ...
	 * @return void
	 */
	public function test_calculate_cart_with_tax() {
	...
	/**
	 * Test calculating cart with shipping.
	 *
	 ...
	 * @return void
	 */
	public function test_calculate_cart_with_shipping() {
		...
		$data = $response->get_data();
		$this->assertArrayHasKey( 'totals', $data );
		$this->assertArrayHasKey( 'shipping', $data['totals'] );
	...
	/**
	 * Test calculating cart with fees.
	 *
	 ...
	 * @return void
	 */
	public function test_calculate_cart_with_fees() {
		// Create test product.
		$product = $this->create_product( array(
			'name'          => 'Test Product',
			'regular_price' => '100.00',
	...
	/**
	 * Test calculating cart with discounts.
	 *
	 ...
	 * @return void
	 */
	public function test_calculate_cart_with_discounts() {
		// Create test product.
		$product = $this->create_product( array(
			'name'          => 'Test Product',
			'regular_price' => '100.00',
	...
	/**
	 * Test calculating empty cart.
	 *
	 * Verifies that calculating an empty cart returns zero totals
	...
	/**
	 * Test calculating cart with return cart parameter.
	 *
	 * Verifies that when return_cart parameter is true, the response
	 * includes the full cart data along with calculations.
	 *
	 * @return void
	 */
	public function test_calculate_cart_with_return_cart() {
		// Create test product.
		$product = $this->create_product( array(
			'name'          => 'Test Product',
			'regular_price' => '25.00',
	...
	/**
	 * Test calculating cart with session parameter.
	 *
	 * Verifies that cart calculations can be performed on a specific
	 * cart session and that the session is properly maintained.
	 *
	 * @return void
	 */
	public function test_calculate_cart_with_session() {
		// Create test product.
		$product = $this->create_product( array(
			'name'          => 'Test Product',
			'regular_price' => '25.00',
	...
	/**
	 * Test calculating cart with invalid session.
	 *
	 * Verifies that attempting to calculate a cart with an invalid session
	 * returns an appropriate error response.
	 *
	 * @return void
	 */
	public function test_calculate_cart_with_invalid_session() {
		// Create test product.
		$product = $this->create_product( array(
			'name'          => 'Test Product',
			'regular_price' => '25.00',
	...
	/**
	 * Test calculating cart with on-sale products.
	 *
	...
	/**
	 * Test calculating cart response structure.
	 *
	 * Verifies that the calculate cart response contains all expected
	 * fields and has the correct data types.
	 *
	 * @return void
	 */
	public function test_calculate_cart_response_structure() {
		// Create test product.
		$product = $this->create_product( array(
			'name'          => 'Test Product',
			'regular_price' => '25.00',
