		...
		<div class="cocart-next-step-action">
			<div class="column">
				...
				<p><?php echo sprintf(
					...
					__( '%3$s is in need of translations. Is the plugin not translated in your language or do you spot errors with the current translations? Helping out is easy!', 'cart-rest-api-for-woocommerce' ),
			...
			<div class="column">
				...
				<p><?php esc_html_e( 'Join the community on Discord to chat with us and fellow CoCart users.', 'cart-rest-api-for-woocommerce' ); ?></p>
