...
<div class="notice notice-info cocart-notice" role="alert">
	<div class="cocart-notice-inner">
		...
		<div class="cocart-action">
			...
			?>
			<a href="<?php echo esc_url( $upgrade_url ); ?>" class="button button-primary cocart-button" role="button"><?php echo esc_html__( 'Update WooCommerce', 'cart-rest-api-for-woocommerce' ); ?></a>
